...
int main() {
    NeuralNetwork *net = new NeuralNetwork({3, 9, 5, 5});
...
//    std::cout << '\n';
    ...
    std::vector<std::vector<float>> train_input = {{0.1, 0.2, 0.3},
                                                   {0.2, 0.4, 0.5},
                                                   {0.6, 0.2, 0.4}};
    std::vector<std::vector<float>> target = {{0.1, 0.1, 0.9, 0.2,  0.1},
                                              {0.3, 0.2, 0.1, 0.1,  0.9},
                                              {0.1, 0.5, 0.2, 0.45, 0.18}};
